//
//this contains only the declaration of waht main cpp file will contain
//we don't mainatain only .cpp files as if we export this into someother code then it it will disrupt in its code execution
...
//enums are like option set (also used as datatype)
//for ex- "face" can only have 6 types of faces(up,left,front,right,back,down)
    enum class FACE {
        UP,
        LEFT,
        FRONT,
