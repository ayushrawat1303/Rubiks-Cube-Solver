...
/*we will be able to use all these classes without actually including this file in 
header file as it base class is defined in ruikscube.h and from there only we 
can access all the functionalites of its descendants*/ 
...
void RubiksCube::print() const {
    // Output the cube face by face, row by row, and column by column.
    // Print color letters for each cell of the cube.
    cout << "Rubik's Cube:\n\n";
